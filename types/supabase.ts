  ...
  public: {
    Tables: {
      advbox_config: {
        ...
        Relationships: [
          {
            foreignKeyName: "advbox_config_organization_id_fkey"
      ...
      advbox_sync_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "advbox_sync_logs_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      asaas_config: {
        ...
        Relationships: [
          {
            foreignKeyName: "asaas_config_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: true
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      honorarios: {
        ...
        Relationships: [
          {
            foreignKeyName: "honorarios_contact_id_fkey"
            columns: ["contact_id"]
            isOneToOne: false
            referencedRelation: "contacts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "honorarios_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      movimentacoes: {
        ...
        Relationships: [
          {
            foreignKeyName: "movimentacoes_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      parcelas: {
        Row: {
          ...
          id: string
          metodo_pagamento:
            | Database["public"]["Enums"]["cobranca_metodo"]
            | null
          numero: number
          organization_id: string
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "parcelas_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      pipelines: {
        ...
        Relationships: [
          {
            foreignKeyName: "pipelines_channel_id_fkey"
            columns: ["channel_id"]
            isOneToOne: false
            referencedRelation: "channels"
            referencedColumns: ["id"]
      ...
      prazos: {
        Row: {
          ...
          tipo: Database["public"]["Enums"]["prazo_tipo"]
          titulo: string
          updated_at: string
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "prazos_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      processos: {
        Row: {
          ...
          fase: Database["public"]["Enums"]["processo_fase"]
          id: string
          numero_cnj: string
          observacoes: string | null
          organization_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "processos_contact_id_fkey"
            columns: ["contact_id"]
            isOneToOne: false
            referencedRelation: "contacts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "processos_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
    ...
    Enums: {
      ...
      deal_stage:
        ...
        | "won"
        | "lost"
      honorario_status: "ativo" | "encerrado" | "cancelado"
      honorario_tipo: "fixo" | "exito" | "misto" | "hora"
      ...
      prazo_tipo:
        ...
        | "peticao_inicial"
        | "outro"
      processo_fase: "conhecimento" | "recursal" | "execucao" | "arquivado"
      processo_status: "ativo" | "suspenso" | "encerrado" | "arquivado"
      processo_tipo:
        | "previdenciario"
        | "trabalhista"
        | "civel"
